...
public class DrawingForest4 extends RandomForest<Drawing,String,DrawingPoint, PixelUse> implements PixelUser {
	private int width, height;

	public DrawingForest4() {
		super(4, Drawing::allFeatures, Drawing::getFeatureValue, PixelUse::successor);
	}
