...
public class DrawingForest40 extends RandomForest<Drawing,String,DrawingPoint, PixelUse> implements PixelUser {
	private int width, height;

	public DrawingForest40() {
		super(40, Drawing::allFeatures, Drawing::getFeatureValue, PixelUse::successor);
	}
